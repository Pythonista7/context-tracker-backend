...
class Session:
    ...
    def start(self) -> int:
        ...
        # Make sure we are not starting a session twice
    ...
    async def generate_session_summary(self, session_id: int) -> SessionSummary:
        ...
        try:
            ...
            session_summary = await self.llm.generate_text(prompt=session_summary_prompt.template,system_context=session_summary_prompt.system_context)
